    ...
    return (document, positions) => {
        ...
        function getTsResult(sourceFile) {
            ...
            for (const sourceMap of tsSourceMaps) {
                ...
                result = result.concat((0, transforms_1.transformSelectionRanges)(tsSelectRange, range => sourceMap.getSourceRange(range.start, range.end)));
            }
            return result;
        }
        function getHtmlResult(sourceFile) {
            ...
            for (const sourceMap of [
                ...
                result = result.concat((0, transforms_1.transformSelectionRanges)(selectRanges, range => sourceMap.getSourceRange(range.start, range.end)));
            }
            return result;
        }
        function getCssResult(sourceFile) {
            ...
            for (const sourceMap of sourceFile.getCssSourceMaps()) {
                ...
                result = result.concat((0, transforms_1.transformSelectionRanges)(cssSelectRanges, range => sourceMap.getSourceRange(range.start, range.end)));
            }
            return result;
        }
    };
