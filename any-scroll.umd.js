(function (global, factory) {
        ...
        function AnyTouch(el, options) {
            ...
            try {
                for (var _c = __values(AnyTouch._$Recognizers), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var _e = __read$2(_d.value, 2), Recognizer_1 = _e[0], options_1 = _e[1];
            ...
            if (void 0 === recognizerName) {
                ...
                try {
                    for (var _b = __values(this._$recognizers.entries()), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var _d = __read$2(_c.value, 2), index = _d[0], recognizer = _d[1];
    ...
    ***************************************************************************** */
    ...
    function createDOMDiv(className) {
        ...
        if (className) {
            (_a = div.classList).add.apply(_a, __spread$1(className));
        }
        return div;
    }
    ...
    function tween(from, to, duration) {
        var _from = __spread$1(from);
        var _to = __spread$1(to);
    ...
    var default_1$2 = (function (_super) {
        ...
        default_1.prototype.set = function (options) {
            this.__options = __assign$1(__assign$1({}, this.__options), options);
            this.update();
        };
        ...
        default_1.prototype.moveTo = function (distXY) {
            ...
            if (allow.includes(true)) {
                var _b = __read$3(this.xy, 2), x = _b[0], y = _b[1];
                var targets = this.targets;
                var target = targets[0];
                this.emit('scroll', { targets: targets, target: target, x: x, y: y });
                setTranslate.apply(void 0, __spread$2([this.el], this.xy));
            }
            return this.xy;
        };
        default_1.prototype.scrollTo = function (distXY, duration) {
            ...
            var _a = __read$3(tween(this.xy, distXY, duration), 3), run = _a[0], stop = _a[1], done = _a[2];
    ...
    function watchWheel (el, onChange) {
        ...
        function __onWheel(e) {
            var _a = __read$3(normalizeWheel(e), 2), deltaX = _a[0], deltaY = _a[1];
            _deltaXCounter += deltaX;
            _deltaYCounter += deltaY;
            function _dispatchEvent(type, payload) {
                var wheelEvent2 = __assign$1({ target: e.target, deltaX: deltaX,
                    deltaY: deltaY,
                    type: type }, payload);
    ...
    var default_1$1 = (function (_super) {
        ...
        function default_1(el, options) {
            ...
            var __options = __assign$1(__assign$1({}, DEFAULT_OPTIONS), options);
            ...
            Array.from(el.children).forEach(function (contentEl) {
                var ref = new default_1$2(contentEl, el, __options);
        ...
        default_1.prototype.__findContentRef = function (targetEl) {
            var e_1, _a;
            try {
                for (var _b = __values$1(this.__contentRefList), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var ref = _c.value;
    ...
    var default_1$3 = (function (_super) {
        ...
        function default_1(el, options) {
            ...
            try {
                for (var plugins_1 = __values$1(plugins), plugins_1_1 = plugins_1.next(); !plugins_1_1.done; plugins_1_1 = plugins_1.next()) {
    ...
    ***************************************************************************** */
    ...
    default_1$3.use(index);
    var default_1 = (function (_super) {
        __extends$2(default_1, _super);
        function default_1(el, options) {
